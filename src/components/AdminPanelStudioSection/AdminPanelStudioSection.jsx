      ...
      <div className='Intro-Studio-Section-title'>
        ...
        <div className='Intro-Studio-Section-form-check'>
          <div class="form-check verify-form">
            {verify? (
              <img className='image-check' onClick={() => {
                setVerify(false)
                setverifycheck(true)}}
                 src="../../public/images/signup/photo_5949261142641720371_m.jpg" alt="Logo" />
            ) : (
              <img className='image-check' onClick={() => {
                setVerify(true)
                setverifycheck(true)}}
                 src="../../public/images/signup/Rectangle 39.png" alt="Logo" />
            )}
          ...
          <div class="form-check form-check-inline prom-form-check">
            ...
            {props.isPromoted ?(
              <img src="../../public/images/studiopanel/🦆 icon _voice ok_.png" alt="" />
            ):(
