...
export default function Footer() {
    ...
    return (
           ...
           <Link to='/'> <img src="../../public/images/similar/New Project (1) 2.svg" alt="Logo" /></Link>
            ...
            <section>
                ...
                <div>
                    ...
                    <span style={{cursor:'pointer'}} onClick={emailRigester}><img src="../../public/images/index/Clip path group.png" alt="" /></span>
                </div>
            </section>
            </main>
      ...
      <img height={100} width={100} style={{margin:'0 auto .8rem auto',display:'block'}}  src="../../public/images/similar/Group 39.png" alt="" />
      <br />
<p>ایمیل شما با موفقیت ثبت شد.</p>
      ...
      <img height={100} width={100} style={{margin:'0 auto .8rem auto',display:'block'}}  src="../../public/images/similar/Group 40.png" alt="" />
      <br />
